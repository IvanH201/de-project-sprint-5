...
from stg.order_system_dag.pg_saver_user import PgSaver
...
class UserLoader:
    ...
    WF_KEY = "ordersystem_users_to_stg_workflow"
    ...
    def run_copy(self) -> int:
        ...
        with self.pg_dest.connection() as conn:
            ...
            load_queue = self.collection_loader.get_users(last_loaded_ts, self.BATCH_LIMIT)
